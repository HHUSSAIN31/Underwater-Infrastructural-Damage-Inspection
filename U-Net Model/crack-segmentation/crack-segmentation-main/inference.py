...
def parse_opt():
    ...
    parser.add_argument("--weights", default="/content/drive/MyDrive/U-Net-Model/cracks/crack-segmentation/crack-segmentation-main/weights/best.pt", help="Path to weight file (default: last.pt)")
    parser.add_argument("--input", type=str, default="/content/drive/MyDrive/U-Net-Model/cracks/crack-segmentation/crack-segmentation-main/data/images", help="Path to input image")
    parser.add_argument("--output", default="results2", help="Path to save mask image")
    ...
    parser.add_argument("--conf-thresh", type=float, default=0.0, help="Confidence threshold for mask")
...
def main(opt):
    ...
    # Load & Inference
    for img_name in tqdm.tqdm(os.listdir(opt.input)):
        
        image_path = os.path.join(opt.input,img_name)
        ...
        result.save(os.path.join(opt.output,img_name))
